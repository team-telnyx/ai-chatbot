const document = `[![Express Logo](https://i.cloudup.com/zfY6lL7eFa-3000x3000.png)](http://expressjs.com/)
...
import { MarkdownSplitter } from '../../../libs/services/documents/splitter/markdown';

/**Failing */
describe('MarkdownSplitter Class Tests', () => {
  test('Split a Markdown to default size chunks', () => {
    ...
    paragraphs.forEach((paragraph) => {
      ...
      expect(paragraph.tokens).toBeLessThan(1000);
    });
